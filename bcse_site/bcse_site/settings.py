...
CRONJOBS = [
    ...
    # run cron at 4 am to export current year workshops and registrations to excel
    ('0 4 * * *', 'bcse_app.cron.export_workshops_registrations', '>> /srv/project/logs/cron.log'),
