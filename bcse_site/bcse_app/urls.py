...
urlpatterns = [
    ...
    path('adminConfiguration/baxter_box/equipmentType/<int:id>/edit', views.equipmentTypeEdit, name='equipmentTypeEdit'),
    path('adminConfiguration/baxter_box/equipmentType/<int:id>/delete', views.equipmentTypeDelete, name='equipmentTypeDelete'),
    path('adminConfiguration/baxter_box/equipmentType/new', views.equipmentTypeEdit, name='equipmentTypeNew'),
    path('adminConfiguration/baxter_box/equipmentTypes/', views.equipmentTypes, name='equipmentTypes'),
    path('adminConfiguration/baxter_box/availabilityCalendar/', views.adminAvailabilityCalendar, name='adminAvailabilityCalendar'),
    path('equipmentType/<int:id>/view', views.equipmentTypeView, name='equipmentTypeView'),
    path('adminConfiguration/baxter_box/equipment/<int:id>/edit', views.equipmentEdit, name='equipmentEdit'),
    path('adminConfiguration/baxter_box/equipment/<int:id>/delete', views.equipmentDelete, name='equipmentDelete'),
    path('adminConfiguration/baxter_box/equipment/new', views.equipmentEdit, name='equipmentNew'),
    path('adminConfiguration/baxter_box/equipments/', views.equipments, name='equipments'),
