...
########################################################################
def checkEquipmentSetAvailability(request, current_reservation_id, equipment_sets, start_date, end_date, delivery_date, return_date):
  equipment_availability_matrix = {}
  delta = return_date - delivery_date
  reservation_days = delta.days + 1
  ...
  for equipment in equipment_sets:
    ...
    equipment_availability_matrix[equipment]['is_available'] = False
