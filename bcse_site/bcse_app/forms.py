...
class ReservationForm(ModelForm):
  ...
  def __init__(self, *args, **kwargs):
    ...
    for field_name, field in list(self.fields.items()):
      if field_name not in ['other_activity', 'equipment_not_needed', 'additional_help_needed', 'activity_kit_not_needed', 'include_gloves_goggles', 'include_gloves', 'include_goggles']:
    ...
    self.fields['include_gloves'].label = 'I would like to borrow gloves.'
