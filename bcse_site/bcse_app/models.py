...
class EquipmentType(models.Model):
  ...
  tags = models.ManyToManyField('SubTag', null=True, blank=True, help_text='Scroll down for more tag options')
...
class WorkshopDetails(models.Model):
  ...
  evergreen_language_title = models.CharField(null=True, blank=True, max_length=256, help_text='Enter Evergreen Language Section Title. Defaults to "Evergreen Language".')
  evergreen_language = RichTextField(null=True, blank=True)
  evergreen_language_display_setting = models.CharField(default='H', max_length=1, choices=WORKSHOP_DETAILS_DISPLAY_CHOICES)
  save_the_date_title = models.CharField(null=True, blank=True, max_length=256, help_text='Enter Save The Date Section Title. Defaults to "Save The Date".')
  save_the_date = RichTextField(null=True, blank=True)
  save_the_date_display_setting = models.CharField(default='H', max_length=1, choices=WORKSHOP_DETAILS_DISPLAY_CHOICES)
  call_for_presenters_title = models.CharField(null=True, blank=True, max_length=256, help_text='Enter Call For Presenters Section Title. Defaults to "Call For Presenters".')
  ...
  call_for_presenters_button_label = models.CharField(null=True, blank=True, max_length=256, help_text='Enter Call For Presenters Button Label. Defaults to the survey name.')
  call_for_presenters_display_setting = models.CharField(default='H', max_length=1, choices=WORKSHOP_DETAILS_DISPLAY_CHOICES)
  faq_title = models.CharField(null=True, blank=True, max_length=256, help_text='FAQ')
  faq = RichTextField(null=True, blank=True)
  faq_display_setting = models.CharField(default='H', max_length=1, choices=WORKSHOP_DETAILS_DISPLAY_CHOICES)
  logistics_information_title = models.CharField(null=True, blank=True, max_length=256, help_text='Enter Logistics Information Section Title. Defaults to "Logistics Information".')
  logistics_information = RichTextField(null=True, blank=True)
  logistics_information_display_setting = models.CharField(default='H', max_length=1, choices=WORKSHOP_DETAILS_DISPLAY_CHOICES)
  thank_you_and_recap_title = models.CharField(null=True, blank=True, max_length=256, help_text='Enter Thank You and Recap Section Title. Defaults to "Thank You and Recap"')
  thank_you_and_recap = RichTextField(null=True, blank=True)
  thank_you_and_recap_display_setting = models.CharField(default='H', max_length=1, choices=WORKSHOP_DETAILS_DISPLAY_CHOICES)
  image_gallery_title = models.CharField(null=True, blank=True, max_length=256, help_text='Enter Image Gallery Section Title. Defaults to "Image Gallery"')
  image_gallery_display_setting = models.CharField(default='H', max_length=1, choices=WORKSHOP_DETAILS_DISPLAY_CHOICES)
  created_date = models.DateTimeField(auto_now_add=True)
  modified_date = models.DateTimeField(auto_now=True)
...
class Activity(models.Model):
  ...
  consumables = models.ManyToManyField('Consumable', null=True, blank=True, help_text='Scroll down for more consumable options')
  equipment_mapping = models.ManyToManyField(EquipmentType, null=True, blank=True, help_text='Scroll down for more equipment options')
  tags = models.ManyToManyField('SubTag', null=True, blank=True, help_text='Scroll down for more tag options')
